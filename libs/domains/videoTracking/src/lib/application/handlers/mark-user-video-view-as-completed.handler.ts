...
@Injectable()
@CommandHandler(MarkUserVideoViewAsCompletedCommand)
export class MarkUserVideoViewAsCompletedHandler extends BaseHandler<
...
> {
  ...
  protected override async handle(
    command: MarkUserVideoViewAsCompletedCommand,
