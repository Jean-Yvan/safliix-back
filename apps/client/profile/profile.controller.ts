...
export class ClientProfileController {
  ...
  async authenticateByPin(@Body() dto: ProfilePinLoginDto, @Req() req: Request) {
  ...
  @ApiResponse({ status: 200, description: 'Token de profil généré' })
  async selectProfile(@Body() dto: SelectProfileDto, @Req() req: Request) {
  ...
  private extractSessionMetadata(req: Request): ProfileSessionMetadata {
